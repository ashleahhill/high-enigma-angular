...
/**
 * Using this site for github.io site as well as the front end for a hosted app. Therefore, I need to rewrite the links when it's served statically like on github.io
...
export default app => {
    const $inject = ['$locationProvider', '$stateProvider', '$urlRouterProvider', '$provide', '$windowProvider'];



    // We have to use hardcoded
    //  value for 'require' so it can be statically built
    const RouterConfig = function($locationProvider, $stateProvider, $urlRouterProvider, $provide, $windowProvider) {
